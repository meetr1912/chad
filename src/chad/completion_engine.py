...
class CompletionEngine:
    ...
    def __init__(self, model_id: str, base_url: str, api_key: str = "",
        ...
        # would live on the server's disk, out of our reach.
    ...
    def load(self) -> float:
        ...
        if not self.effective_ctx:
            # An explicitly pinned window means NO probe: an operator who pinned
            # everything shouldn't wait on a socket timeout to start.
